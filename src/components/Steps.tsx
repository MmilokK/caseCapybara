...
const STEPS = [
    {
        name: "Шаг 1. Добавьте картинку",
        description: "Выберите изаображение для вашего чехла",
        url: "/upload"
    },
    {
        name: "Шаг 2. Кастомизируйте дизайн",
        description: "Сделайте чехол по вашему вкусу",
        url: "/design"
    },
    {
        name: "Шаг 3. Итоги",
        description: "Подтвердите конечный результат",
        url: "/preview"
    },
]
    ...
    return(
        <ol className="rounded-md bg-white lg:flex lg:rounded-none lg:border-r lg:border-gray-200">
            {STEPS.map((step, i)=>{
                ...
                const imgPath = `/capybara-${i+1}.png`
                    ...
                    <div>
                        ...
                        <span className={cn(i !== 0 ? 'lg:pl-9' : '', 'flex items-center px-6 py-4 text-sm font-medium')}>
                            <span className="flex-shrink-0">
                                <img src = {imgPath} className={cn("flex h-28 w-28 object-contain items-center justify-center", {
